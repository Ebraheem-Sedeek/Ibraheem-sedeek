...
<section class="container mt-5 ">
       ...
       <form method="post" class="row g-3 text-center">
           ...
           <span  class="border border-dark p-3">
                   ...
                   <h1 class="display-4 text-warning">Get Root Of Numbers </h1>
               ...
               <div class="col-md-12 ">       
                ...
                <div class="col-12 mt-5">
                   <button type="submit" class="btn btn-outline-warning col-12">Check</button>
                </div>
           </span>
           </span>
       </form>    
       <section class="border rounded-2 bg-warning p-3  col-12m-auto mt-4">
           <h2 class="display-5 text-light">The Percentage and grade Is  : <?php echo $percentage ?? ""; ?> <?php echo $grade ?? ""; ?></h2>
       </section>
