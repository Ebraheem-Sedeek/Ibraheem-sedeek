...
<section class="container mt-5 ">
       ...
       <form method="post" class="row g-3 text-center">
           ...
           <span  class="border border-dark p-3">
                   ...
                   <h1 class="display-4 text-warning">Calculator  </h1>
               ...
               <div class="col-md-12 ">       
                ...
                <div class="col-md-12 mt-5">
                    ...
                    <option selected>Choose the arithmetic operation</option>
       ...
       <section class="border rounded-2 bg-warning p-3  col-12 m-auto mt-4 ">
